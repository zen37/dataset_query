-- Requires these environment variables to point at local or ADLS files:
-- DUCKDB_TELEMETRY_PATH, DUCKDB_ERRORS_PATH, DUCKDB_MAINT_PATH,
-- DUCKDB_FAILURES_PATH, and DUCKDB_MACHINES_PATH.
